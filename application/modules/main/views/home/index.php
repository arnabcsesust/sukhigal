<form id="signUpForm" action="<?php echo base_url() . 'main/home'; ?>" method="POST">
    <div class="row-fluid">
        <h3>Sign Up</h3><hr/>
    </div>
    <div class="row-fluid">
        <div class="span12">
            <input type="text" placeholder="Name" class="input-block-level" name='name' id='name' />
        </div>
    </div>
    <div class="row-fluid">
        <div class="span12">
            <input type="text" placeholder="Email" class="input-block-level" name='email' id='email' />
        </div>
    </div>
    <div class="row-fluid">
        <div class="span12">
            <input type="text" class="input-block-level" placeholder="Mobile No" name='mobNo' id='mobNo' />
        </div>
    </div>
    <div class="row-fluid">
        <div class="span12">
    ...
    <div class="row-fluid">
        <div class="span12">
            <input type="password" class="input-block-level" placeholder="Repeat Password" name='rep-password' id='rep-password' />
        </div>
    </div>
    <!--    
        <div class="row-fluid">
    ...
    <div class="row-fluid">
        <div class='span12' id="form-submit-button">
            <input type="submit" class="btn btn-large btn-block btn-success" value="Sign Up" />
        </div>
    </div>
    <div class="row-fluid">
        <div class='span1' id="ajax-loader">
...
<script type='text/javascript'>
    $(document).ready(function() {
        ...
        $('#genderID').change(function() {
            $.ajax({
                url: '<?php echo base_url() . 'main/home/getBodyHeightByGender' ?>',
                type: 'POST',
            ...
            $.ajax({
                url: '<?php echo base_url() . 'main/home/getAgeByGender' ?>',
                type: 'POST',
                data: '&genderID=' + $(this).val(),
                success: function(res) {
        ...
        $('#areaID').change(function() {
            $.ajax({
                url: '<?php echo base_url() . 'main/home/getSubAreaByArea' ?>',
                type: 'POST',
        ...
        $('#signUpForm').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(res) {
                    $('#ajax-loader').hide();
                    if (res == 1) {
                        window.location = "<?php echo base_url() . 'main/home/signupsuccess/' ?>";
                    }
                    else {
